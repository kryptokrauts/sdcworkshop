...
export class CanClaimData extends ActionData {
    constructor(public claimContract: Name) {
        super();
    }
}

export function sendCanClaim(rewardContract: Name, claimContract: Name): void {
    ...
    action.send(new CanClaimData(claimContract));
}
